using CashFlow.Application.UseCases.Expense.Reports.Pdf.Colors;
using CashFlow.Application.UseCases.Expense.Reports.Pdf.Fonts;
...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        // Here you would implement the logic to generate a PDF report using a PDF library
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "João Alves";
    ...
    private void CreateHeaderWithProfileAndName(Section page)
    {
        ...
        row.Cells[1].AddParagraph($"Hey, Joao Alves");
    ...
    private void HeaderForAmount(Cell cell)
    {
